...
d.writeln('var ov_pos_src = document.getElementById("bkm_comment_overwrite_pos");');
d.writeln('var ov_pos = ov_pos_src.getElementsByTagName("option").item(ov_pos_src.selectedIndex).value;');
d.writeln('if(ov_pos === "after") {');
...
d.writeln('} else {');
d.writeln('bkm_body += \'var tmpv1=document.getElementById("comments").value;\';');
d.writeln('bkm_body += \'document.getElementById("comments").value = \' + "\'" + val1 + "\'";');
d.writeln('bkm_body += \' + "\\\\n\\\\n" + tmpv1;\';');
d.writeln('}');
	d.writeln('}else{');
...
d.writeln('<label>位置');
d.writeln('<select id="bkm_comment_overwrite_pos">');
d.writeln('<option value="after">後</option>');
d.writeln('<option value="before">前</option>');
d.writeln('</select>');
d.writeln('</label>');
	d.writeln('</dt>');
